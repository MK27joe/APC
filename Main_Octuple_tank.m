...
run_count=2000;   % simulation run count
...
randn('seed', 100); dist_seq_fd1 =  dist_fd1 * randn(run_count, 1) ;
randn('seed', 200); dist_seq_fd2  =  dist_fd2 * randn(run_count, 1) ;
...
% % 
save octuple_tank_data_30_08_24 res
